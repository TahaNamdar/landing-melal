  ...
  return (
    <>
      <div>
        <div
          className={cn(
            " flex-col  md:flex justify-around  md:flex-row shadow-xl  p-8 items-center mx-auto mt-4 min-h-[400px] xl:h-[400px] rounded-4xl transition-all duration-300 ease-in-out ",
